    ...
    >
      ...
      <template #content>
        <div class="scroll-context">
          <Checkbox.Group
            v-model:value="columnCheckedOptions"
...
import { TableRowSelection } from "../../types/table";
...
const sortableFix = async () => {
  ...
  if (columnOptionsRef.value) {
    const el = (columnOptionsRef.value as InstanceType<typeof Checkbox.Group>)
      .$el;
...
// const restore = () => {
//   if (typeof route.name === "string") {
//     const isIndexColumnShowCache = tableSettingStore.getShowIndexColumn(
//       route.name
//     );
//     // 设置过才恢复
//     if (typeof isIndexColumnShowCache === "boolean") {
//       isIndexColumnShow.value =
//         defaultIsIndexColumnShow && isIndexColumnShowCache;
//     }

//     const isRowSelectionShowCache = tableSettingStore.getShowRowSelection(
//       route.name
//     );
//     // 设置过才恢复
//     if (typeof isRowSelectionShowCache === "boolean") {
//       isRowSelectionShow.value =
//         defaultIsRowSelectionShow && isRowSelectionShowCache;
//     }
//   }
//   // 序号列更新
//   onIndexColumnShowChange({
...
const init = async () => {
  if (!isRestored) {
    ...
    // 默认值 缓存
    defaultIsIndexColumnShow =
      table.getBindValues.value.showIndexColumn || false;
